...
- `/zh/method`, `/zh/sources`, `/zh/faq`, `/sitemap.xml`, `/robots.txt`, and `/llms.txt` support SEO and GEO. Unprefixed `/about`, `/method`, `/sources`, `/faq`, `/principles`, `/quotes`, and `/books` redirect to the default `/zh` tree.
